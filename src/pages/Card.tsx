    ...
    <Box sx={{alignContent:"center", alignItems:"center", justifyContent:"center", justifyItems:"center", textAlign:"center", display:"flex", position:"relative"}}>
      {oceanData.title&& <div>
        ...
        <Tooltip title={<div style={{fontSize:"15px"}}>설정</div>}>
          <IconButton type="submit" size="medium" sx={{position:"absolute", top:"35px", right:"9.1%", color: "white", bgcolor:"#9B9A97", zIndex:"1000",
            "&:hover":{
              "@keyframes rotate": {
                "100%": {
        ...
        <Tooltip title={<div style={{fontSize:"15px", wordWrap: "normal", width:"200px" }}>저장된 HTML파일을 노션에서 "가져오기"해서 추가해보세요!</div>}>
          <IconButton type="submit" size="medium" sx={{position:"absolute", top:"35px", right:"9.1%", color: "white", bgcolor:"#0B6E99", zIndex:"1000",
          "&:hover":{
              transform: "scale(1.1)",
              color: "#0B6E99", 
              bgcolor:"white"
